...
The URL of the GitHub repository is https://github.com/usflfelipe/text-editor

The application has been deployed to Heroku and the URL of the deployed application is:
 
https://text-editor-ch19-b8990938beba.herokuapp.com/
...
``````
*Below is the screenshot of the text editor*
